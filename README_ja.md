...
- [💡 コアとなる設計思想](#-コアとなる設計思想)
- [📚 詳細ドキュメント](#-詳細ドキュメント)
- [🚀 クイックスタート（インストール手順）](#-クイックスタートインストール手順)
  - [Step 1: リポジトリの取得](#step-1-リポジトリの取得)
  - [Step 2: Lyra依存プラグインの移植 (必須)](#step-2-lyra依存プラグインの移植-必須)
...
完全なポリシーについては [AI_POLICY.md](AI_POLICY.md) をご確認ください。
