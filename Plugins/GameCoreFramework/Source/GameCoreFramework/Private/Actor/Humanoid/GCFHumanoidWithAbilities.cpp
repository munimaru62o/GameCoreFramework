...
#include "Actor/Humanoid/GCFHumanoidWithAbilities.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GCFHumanoidWithAbilities)


AGCFHumanoidWithAbilities::AGCFHumanoidWithAbilities(const FObjectInitializer& ObjectInitializer)
...
UAbilitySystemComponent* AGCFHumanoidWithAbilities::GetAbilitySystemComponent() const
{
	return AbilitySystemComponent;
}


void AGCFHumanoidWithAbilities::OnAbilitySystemInitialized()
{
...
void AGCFHumanoidWithAbilities::OnAbilitySystemUninitialized()
{
	HealthComponent->UninitializeFromAbilitySystem();
}


void AGCFHumanoidWithAbilities::GetOwnedGameplayTags(FGameplayTagContainer& TagContainer) const
{
...
bool AGCFHumanoidWithAbilities::HasMatchingGameplayTag(FGameplayTag TagToCheck) const
{
...
bool AGCFHumanoidWithAbilities::HasAllMatchingGameplayTags(const FGameplayTagContainer& TagContainer) const
{
...
bool AGCFHumanoidWithAbilities::HasAnyMatchingGameplayTags(const FGameplayTagContainer& TagContainer) const
{
