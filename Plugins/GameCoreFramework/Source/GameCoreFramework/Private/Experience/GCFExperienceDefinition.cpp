...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GCFExperienceDefinition)

#define LOCTEXT_NAMESPACE "GCFSystem"

UGCFExperienceDefinition::UGCFExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UGCFExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UGCFExperienceDefinition::UpdateAssetBundleData()
{
