...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GCFUserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* UGCFUserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
