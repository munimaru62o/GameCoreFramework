...
{
UE_DEFINE_GAMEPLAY_TAG_COMMENT(FeatureState_Initial, "FeatureState.Initial", "Event that fires on death");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(FeatureState_Ready, "FeatureState.Ready", "Event that fires on death");

UE_DEFINE_GAMEPLAY_TAG_COMMENT(Gameplay_Movement_Stop, "Gameplay.Movement.Stop", "Movement stop");

UE_DEFINE_GAMEPLAY_TAG_COMMENT(GameplayEvent_Dead, "Gameplay.Event.Dead", "Event that fires on death");

UE_DEFINE_GAMEPLAY_TAG_COMMENT(GameplayEffect_DamageType_Basic, "GameplayEffect.DamageType.Basic", "");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(GameplayEffect_DamageType_Heal, "GameplayEffect.DamageType.Heal", "");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_MoveUp, "InputTag.MoveUp", "MoveUp input.");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Ability_Player, "InputTag.Ability.Player", "InputTag Ability Player Prefix.");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Ability_Pawn, "InputTag.Ability.Pawn", "InputTag Ability Pawn Prefix.");

UE_DEFINE_GAMEPLAY_TAG_COMMENT(Camera_Mode_TopDown, "Camera.Mode.TopDown", "Camera Mode TopDown");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Camera_Mode_ThirdPerson, "Camera.Mode.ThirdPerson", "Camera Mode ThirdPerson");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(State_JumpBlocked, "State.JumpBlocked", "Jump is blocking.");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Message_Elimination, "Message.Elimination", "");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Message_Camera_ModeChange, "Message.Camera.ModeChange", "");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Message_PolicyChange_Cursor, "Message.PolicyChange.Cursor", "");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Message_PolicyChange_MovementRotation, "Message.PolicyChange.MovementRotation", "");

UE_DEFINE_GAMEPLAY_TAG_COMMENT(Message_Debug_Log, "Message.Debug.Log", "");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Message_Debug_State, "Message.Debug.State", "");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Message_Debug_Input, "Message.Debug.Input", "");
...
// When extending Mws, you can create your own movement modes but you need to update GetCustomMovementModeTagMap()
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Movement_Mode_Custom, "Movement.Mode.Custom", "This is invalid and should be replaced with custom tags.  See MwsGameplayTags::CustomMovementModeTagMap.");
	...
	if (!Tag.IsValid() && bMatchPartialString) {
		...
		for (const FGameplayTag& TestTag : AllTags) {
			if (TestTag.ToString().Contains(TagString)) {
				UE_LOG(LogGCFSystem, Display, TEXT("Could not find exact match for tag [%s] but found partial match on tag [%s]."), *TagString, *TestTag.ToString());
				Tag = TestTag;
				break;
			}
		}
