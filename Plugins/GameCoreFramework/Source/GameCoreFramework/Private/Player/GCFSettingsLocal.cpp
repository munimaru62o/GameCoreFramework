...
//#include "Performance/GCFPerformanceStatTypes.h"
//#include "ICommonUIModule.h"
//#include "CommonUISettings.h"
//#include "SoundControlBusMix.h"
//#include "Widgets/Layout/SSafeZone.h"
//#include "Performance/GCFPerformanceSettings.h"
//#include "DeviceProfiles/DeviceProfileManager.h"
//#include "DeviceProfiles/DeviceProfile.h"
//#include "HAL/PlatformFramePacer.h"
//#include "Development/GCFPlatformEmulationSettings.h"
//#include "SoundControlBus.h"
//#include "AudioModulationStatics.h"
//#include "Audio/GCFAudioSettings.h"
//#include "Audio/GCFAudioMixEffectsSubsystem.h"
//
//#include UE_INLINE_GENERATED_CPP_BY_NAME(GCFSettingsLocal)
//
...
// 
// 
UGCFSettingsLocal::UGCFSettingsLocal()
{
	SetToDefaults();
}
UGCFSettingsLocal* UGCFSettingsLocal::Get()
{
	return nullptr;
}
...
//
//#if WITH_EDITOR
//static TAutoConsoleVariable<bool> CVarApplyFrameRateSettingsInPIE(TEXT("GCF.Settings.ApplyFrameRateSettingsInPIE"),
//	false,
//	TEXT("Should we apply frame rate settings in PIE?"),
//	ECVF_Default);
//
//static TAutoConsoleVariable<bool> CVarApplyFrontEndPerformanceOptionsInPIE(TEXT("GCF.Settings.ApplyFrontEndPerformanceOptionsInPIE"),
//	false,
//	TEXT("Do we apply front-end specific performance options in PIE?"),
//	ECVF_Default);
//
//static TAutoConsoleVariable<bool> CVarApplyDeviceProfilesInPIE(TEXT("GCF.Settings.ApplyDeviceProfilesInPIE"),
//	false,
...
//	TEXT("GCF.DeviceProfile.Console.TargetFPS"),
//	-1,
...
//	TEXT("GCF.DeviceProfile.Console.FrameSyncType"),
//	-1,
...
//	TEXT("GCF.DeviceProfile.Mobile.DefaultFrameRate"),
//	30,
...
//	TEXT("GCF.DeviceProfile.Mobile.MaxFrameRate"),
//	30,
...
//	TEXT("GCF.DeviceProfile.Mobile.OverallQualityLimits"),
//	TEXT(""),
...
//	TEXT("GCF.DeviceProfile.Mobile.ResolutionQualityLimits"),
//	TEXT(""),
...
//	TEXT("GCF.DeviceProfile.Mobile.ResolutionQualityRecommendation"),
//	TEXT("0:75"),
...
////////////////////////////////////////////////////////////////////////
//
//FGCFScalabilitySnapshot::FGCFScalabilitySnapshot()
//{
...
//	}
//
//	void FillScalabilitySettingsFromDeviceProfile(FGCFScalabilitySnapshot& Mode, const FString& Suffix = FString())
//	{
//		static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
//
...
//	{
//		const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
...
//			
//			const bool bIsSupported = UGCFSettingsLocal::IsSupportedMobileFramePace(TestRate);
//
//			return bAtOrBelowDesiredRate && bQualityDoesntExceedLimit && bIsSupported;
//		});
//
//		return PossibleRates.IsValidIndex(LimitIndex) ? PossibleRates[LimitIndex] : UGCFSettingsLocal::GetDefaultMobileFrameRate();
//	}
//
...
//	}
//
//	bEnableScalabilitySettings = UGCFPlatformSpecificRenderingSettings::Get()->bSupportsGranularVideoQualitySettings;
//
//	SetToDefaults();
//}
//
//void UGCFSettingsLocal::SetToDefaults()
//{
//	Super::SetToDefaults();
//
...
//	bEnableLatencyTrackingStats = UGCFSettingsLocal::DoesPlatformSupportLatencyTrackingStats();
//
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
...
//}
//
//void UGCFSettingsLocal::LoadSettings(bool bForceReload)
//{
//	Super::LoadSettings(bForceReload);
//
//	// Console platforms use rhi.SyncInterval to limit framerate
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
//	if (PlatformSettings->FramePacingMode == EGCFFramePacingMode::ConsoleStyle)
//	{
//		FrameRateLimit = 0.0f;
//	}
//
...
//	DesiredUserChosenDeviceProfileSuffix = UserChosenDeviceProfileSuffix;
//
//	GCFSettingsHelpers::FillScalabilitySettingsFromDeviceProfile(DeviceDefaultScalabilitySettings);
//
//	DesiredMobileFrameRateLimit = MobileFrameRateLimit;
//	ClampMobileQuality();
//
...
//}
//
//void UGCFSettingsLocal::ResetToCurrentSettings()
//{
...
//}
//
//void UGCFSettingsLocal::BeginDestroy()
//{
...
//UGCFSettingsLocal* UGCFSettingsLocal::Get()
//{
//	return GEngine ? CastChecked<UGCFSettingsLocal>(GEngine->GetGameUserSettings()) : nullptr;
//}
//
//void UGCFSettingsLocal::ConfirmVideoMode()
//{
...
//}
//
//float UGCFSettingsLocal::GetEffectiveFrameRateLimit()
//{
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
//
//#if WITH_EDITOR
...
//	}
//
//	if (PlatformSettings->FramePacingMode == EGCFFramePacingMode::DesktopStyle)
//	{
...
//}
//
//int32 UGCFSettingsLocal::GetHighestLevelOfAnyScalabilityChannel() const
//{
//	return GCFSettingsHelpers::GetHighestLevelOfAnyScalabilityChannel(ScalabilityQuality);
//}
//
//void UGCFSettingsLocal::OverrideQualityLevelsToScalabilityMode(const FGCFScalabilitySnapshot& InMode, Scalability::FQualityLevels& InOutLevels)
//{
//	static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
//
...
//}
//
//void UGCFSettingsLocal::ClampQualityLevelsToDeviceProfile(const Scalability::FQualityLevels& ClampLevels, Scalability::FQualityLevels& InOutLevels)
//{
//	static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
//
...
//}
//
//void UGCFSettingsLocal::OnExperienceLoaded()
//{
//	ReapplyThingsDueToPossibleDeviceProfileChange();
//}
//
//void UGCFSettingsLocal::OnHotfixDeviceProfileApplied()
//{
//	ReapplyThingsDueToPossibleDeviceProfileChange();
//}
//
//void UGCFSettingsLocal::ReapplyThingsDueToPossibleDeviceProfileChange()
//{
//	ApplyNonResolutionSettings();
//}
//
//void UGCFSettingsLocal::SetShouldUseFrontendPerformanceSettings(bool bInFrontEnd)
//{
//	bInFrontEndForPerformancePurposes = bInFrontEnd;
//	UpdateEffectiveFrameRateLimit();
//}
//
//bool UGCFSettingsLocal::ShouldUseFrontendPerformanceSettings() const
//{
//#if WITH_EDITOR
...
//}
//
//EGCFStatDisplayMode UGCFSettingsLocal::GetPerfStatDisplayState(EGCFDisplayablePerformanceStat Stat) const
//{
//	if (const EGCFStatDisplayMode* pMode = DisplayStatList.Find(Stat))
//	{
//		return *pMode;
//	}
//	else
//	{
//		return EGCFStatDisplayMode::Hidden;
//	}
//}
//
//void UGCFSettingsLocal::SetPerfStatDisplayState(EGCFDisplayablePerformanceStat Stat, EGCFStatDisplayMode DisplayMode)
//{
//	if (DisplayMode == EGCFStatDisplayMode::Hidden)
//	{
...
//}
//
//bool UGCFSettingsLocal::DoesPlatformSupportLatencyMarkers()
//{
//	return ICommonUIModule::GetSettings().GetPlatformTraits().HasTag(PerfStatTags::TAG_Platform_Trait_SupportsLatencyMarkers);
//}
//
//void UGCFSettingsLocal::SetEnableLatencyFlashIndicators(const bool bNewVal)
//{
...
//}
//
//void UGCFSettingsLocal::SetEnableLatencyTrackingStats(const bool bNewVal)
//{
...
//}
//
//void UGCFSettingsLocal::ApplyLatencyTrackingStatSetting()
//{
...
//}
//
//bool UGCFSettingsLocal::DoesPlatformSupportLatencyTrackingStats()
//{
//	return ICommonUIModule::GetSettings().GetPlatformTraits().HasTag(PerfStatTags::TAG_Platform_Trait_SupportsLatencyStats);
//}
//
//float UGCFSettingsLocal::GetDisplayGamma() const
//{
//	return DisplayGamma;
//}
//
//void UGCFSettingsLocal::SetDisplayGamma(float InGamma)
//{
//	DisplayGamma = InGamma;
//	ApplyDisplayGamma();
//}
//
//void UGCFSettingsLocal::ApplyDisplayGamma()
//{
//	if (GEngine)
//	{
...
//}
//
//float UGCFSettingsLocal::GetFrameRateLimit_OnBattery() const
//{
//	return FrameRateLimit_OnBattery;
//}
//
//void UGCFSettingsLocal::SetFrameRateLimit_OnBattery(float NewLimitFPS)
//{
//	FrameRateLimit_OnBattery = NewLimitFPS;
//	UpdateEffectiveFrameRateLimit();
//}
//
//float UGCFSettingsLocal::GetFrameRateLimit_InMenu() const
//{
//	return FrameRateLimit_InMenu;
//}
//
//void UGCFSettingsLocal::SetFrameRateLimit_InMenu(float NewLimitFPS)
//{
//	FrameRateLimit_InMenu = NewLimitFPS;
//	UpdateEffectiveFrameRateLimit();
//}
//
//float UGCFSettingsLocal::GetFrameRateLimit_WhenBackgrounded() const
//{
//	return FrameRateLimit_WhenBackgrounded;
//}
//
//void UGCFSettingsLocal::SetFrameRateLimit_WhenBackgrounded(float NewLimitFPS)
//{
//	FrameRateLimit_WhenBackgrounded = NewLimitFPS;
//	UpdateEffectiveFrameRateLimit();
//}
//
//float UGCFSettingsLocal::GetFrameRateLimit_Always() const
//{
//	return GetFrameRateLimit();
//}
//
//void UGCFSettingsLocal::SetFrameRateLimit_Always(float NewLimitFPS)
//{
//	SetFrameRateLimit(NewLimitFPS);
//	UpdateEffectiveFrameRateLimit();
//}
//
//void UGCFSettingsLocal::UpdateEffectiveFrameRateLimit()
//{
...
//}
//
//int32 UGCFSettingsLocal::GetDefaultMobileFrameRate()
//{
//	return CVarDeviceProfileDrivenMobileDefaultFrameRate.GetValueOnGameThread();
//}
//
//int32 UGCFSettingsLocal::GetMaxMobileFrameRate()
//{
//	return CVarDeviceProfileDrivenMobileMaxFrameRate.GetValueOnGameThread();
//}
//
//bool UGCFSettingsLocal::IsSupportedMobileFramePace(int32 TestFPS)
//{
...
//}
//
//int32 UGCFSettingsLocal::GetFirstFrameRateWithQualityLimit() const
//{
//	return GCFSettingsHelpers::GetFirstFrameRateWithQualityLimit();
//}
//
//int32 UGCFSettingsLocal::GetLowestQualityWithFrameRateLimit() const
//{
//	return GCFSettingsHelpers::GetLowestQualityWithFrameRateLimit();
//}
//
//void UGCFSettingsLocal::ResetToMobileDeviceDefaults()
//{
//	// Reset frame rate
...
//}
//
//int32 UGCFSettingsLocal::GetMaxSupportedOverallQualityLevel() const
//{
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
//	if ((PlatformSettings->FramePacingMode == EGCFFramePacingMode::MobileStyle) && DeviceDefaultScalabilitySettings.bHasOverrides)
//	{
//		return GCFSettingsHelpers::GetHighestLevelOfAnyScalabilityChannel(DeviceDefaultScalabilitySettings.Qualities);
//	}
//	else
//	{
//		return 3;
...
//}
//
//void UGCFSettingsLocal::SetMobileFPSMode(int32 NewLimitFPS)
//{
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
//	if (PlatformSettings->FramePacingMode == EGCFFramePacingMode::MobileStyle)
//	{
...
//}
//
//void UGCFSettingsLocal::SetDesiredMobileFrameRateLimit(int32 NewLimitFPS)
//{
...
//}
//
//void UGCFSettingsLocal::ClampMobileFPSQualityLevels(bool bWriteBack)
//{
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
//	if (PlatformSettings->FramePacingMode == EGCFFramePacingMode::MobileStyle)
//	{
//		const int32 QualityLimit = GCFSettingsHelpers::GetApplicableOverallQualityLimit(DesiredMobileFrameRateLimit);
...
//}
//
//void UGCFSettingsLocal::ClampMobileQuality()
//{
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
//	if (PlatformSettings->FramePacingMode == EGCFFramePacingMode::MobileStyle)
//	{
...
//}
//
//void UGCFSettingsLocal::ClampMobileResolutionQuality(int32 TargetFPS)
//{
//	// Clamp mobile resolution quality
//	float MaxMobileResQuality = GCFSettingsHelpers::GetApplicableResolutionQualityLimit(TargetFPS);
...
//}
//
//void UGCFSettingsLocal::RemapMobileResolutionQuality(int32 FromFPS, int32 ToFPS)
//{
...
//	float MaxScaleValue = 0.0f;
//	GetResolutionScaleInformationEx(CurrentScaleNormalized, CurrentScaleValue, MinScaleValue, MaxScaleValue);
//	float FromMaxMobileResQuality = GCFSettingsHelpers::GetApplicableResolutionQualityLimit(FromFPS);
//	float ToMaxMobileResQuality = GCFSettingsHelpers::GetApplicableResolutionQualityLimit(ToFPS);
...
//}
//
//FString UGCFSettingsLocal::GetDesiredDeviceProfileQualitySuffix() const
//{
//	return DesiredUserChosenDeviceProfileSuffix;
//}
//
//void UGCFSettingsLocal::SetDesiredDeviceProfileQualitySuffix(const FString& InDesiredSuffix)
//{
//	DesiredUserChosenDeviceProfileSuffix = InDesiredSuffix;
//}
//
//void UGCFSettingsLocal::SetHeadphoneModeEnabled(bool bEnabled)
//{
...
//}
//
//bool UGCFSettingsLocal::IsHeadphoneModeEnabled() const
//{
//	return bUseHeadphoneMode;
//}
//
//bool UGCFSettingsLocal::CanModifyHeadphoneModeEnabled() const
//{
//	static IConsoleVariable* BinauralSpatializationDisabledCVar = IConsoleManager::Get().FindConsoleVariable(TEXT("au.DisableBinauralSpatialization"));
...
//
//	const bool bBinauralSettingControlledByOS = GCFSettingsHelpers::HasPlatformTrait(TAG_Platform_Trait_BinauralSettingControlledByOS);
//
//	return bHRTFOptionAvailable && !bBinauralSettingControlledByOS;
//}
//
//bool UGCFSettingsLocal::IsHDRAudioModeEnabled() const
//{
//	return bUseHDRAudioMode;
//}
//
//void UGCFSettingsLocal::SetHDRAudioModeEnabled(bool bEnabled)
//{
...
//		{
//			if (UGCFAudioMixEffectsSubsystem* GCFAudioMixEffectsSubsystem = World->GetSubsystem<UGCFAudioMixEffectsSubsystem>())
//			{
//				GCFAudioMixEffectsSubsystem->ApplyDynamicRangeEffectsChains(bEnabled);
//			}
//		}
//	}
//}
//
//bool UGCFSettingsLocal::CanRunAutoBenchmark() const
//{
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
//	return PlatformSettings->bSupportsAutomaticVideoQualityBenchmark;
//}
//
//bool UGCFSettingsLocal::ShouldRunAutoBenchmarkAtStartup() const
//{
...
//}
//
//void UGCFSettingsLocal::RunAutoBenchmark(bool bSaveImmediately)
//{
...
//}
//
//void UGCFSettingsLocal::ApplyScalabilitySettings()
//{
//	Scalability::SetQualityLevels(ScalabilityQuality);
//}
//
//float UGCFSettingsLocal::GetOverallVolume() const
//{
//	return OverallVolume;
//}
//
//void UGCFSettingsLocal::SetOverallVolume(float InVolume)
//{
...
//}
//
//float UGCFSettingsLocal::GetMusicVolume() const
//{
//	return MusicVolume;
//}
//
//void UGCFSettingsLocal::SetMusicVolume(float InVolume)
//{
//	// Cache the incoming volume value
...
//}
//
//float UGCFSettingsLocal::GetSoundFXVolume() const
//{
//	return SoundFXVolume;
//}
//
//void UGCFSettingsLocal::SetSoundFXVolume(float InVolume)
//{
//	// Cache the incoming volume value
...
//}
//
//float UGCFSettingsLocal::GetDialogueVolume() const
//{
//	return DialogueVolume;
//}
//
//void UGCFSettingsLocal::SetDialogueVolume(float InVolume)
//{
//	// Cache the incoming volume value
...
//}
//
//float UGCFSettingsLocal::GetVoiceChatVolume() const
//{
//	return VoiceChatVolume;
//}
//
//void UGCFSettingsLocal::SetVoiceChatVolume(float InVolume)
//{
//	// Cache the incoming volume value
...
//}
//
//void UGCFSettingsLocal::SetVolumeForControlBus(USoundControlBus* InSoundControlBus, float InVolume)
//{
//	// Check to see if references to the control buses and control bus mixes have been loaded yet
...
//}
//
//void UGCFSettingsLocal::SetAudioOutputDeviceId(const FString& InAudioOutputDeviceId)
//{
//	AudioOutputDeviceId = InAudioOutputDeviceId;
//	OnAudioOutputDeviceChanged.Broadcast(InAudioOutputDeviceId);
//}
//
//void UGCFSettingsLocal::ApplySafeZoneScale()
//{
//	SSafeZone::SetGlobalSafeZoneScale(GetSafeZone());
//}
//
//void UGCFSettingsLocal::ApplyNonResolutionSettings()
//{
...
//}
//
//int32 UGCFSettingsLocal::GetOverallScalabilityLevel() const
//{
...
//}
//
//void UGCFSettingsLocal::SetOverallScalabilityLevel(int32 Value)
//{
...
//		const int32 ConstrainedFrameRateLimit = GCFSettingsHelpers::ConstrainFrameRateToBeCompatibleWithOverallQuality(DesiredMobileFrameRateLimit, Value);
...
//}
//
//void UGCFSettingsLocal::SetControllerPlatform(const FName InControllerPlatform)
//{
...
//}
//
//FName UGCFSettingsLocal::GetControllerPlatform() const
//{
//	return ControllerPlatform;
//}
//
//void UGCFSettingsLocal::LoadUserControlBusMix()
//{
//	if (GEngine)
//	{
//		if (const UWorld* World = GEngine->GetCurrentPlayWorld())
//		{
//			if (const UGCFAudioSettings* GCFAudioSettings = GetDefault<UGCFAudioSettings>())
//			{
...
//				ControlBusMap.Empty();
//
//				if (UObject* ObjPath = GCFAudioSettings->OverallVolumeControlBus.TryLoad())
//				{
...
//					else
//					{
//						ensureMsgf(SoundControlBus, TEXT("Overall Control Bus reference missing from GCF Audio Settings."));
//					}
//				}
//
//				if (UObject* ObjPath = GCFAudioSettings->MusicVolumeControlBus.TryLoad())
//				{
//					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
//					{
...
//					else
//					{
//						ensureMsgf(SoundControlBus, TEXT("Music Control Bus reference missing from GCF Audio Settings."));
//					}
//				}
//
//				if (UObject* ObjPath = GCFAudioSettings->SoundFXVolumeControlBus.TryLoad())
//				{
//					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
//					{
...
//					else
//					{
//						ensureMsgf(SoundControlBus, TEXT("SoundFX Control Bus reference missing from GCF Audio Settings."));
//					}
//				}
//
//				if (UObject* ObjPath = GCFAudioSettings->DialogueVolumeControlBus.TryLoad())
//				{
//					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
//					{
...
//					else
//					{
//						ensureMsgf(SoundControlBus, TEXT("Dialogue Control Bus reference missing from GCF Audio Settings."));
//					}
//				}
//
//				if (UObject* ObjPath = GCFAudioSettings->VoiceChatVolumeControlBus.TryLoad())
//				{
//					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
//					{
...
//					else
//					{
//						ensureMsgf(SoundControlBus, TEXT("VoiceChat Control Bus reference missing from GCF Audio Settings."));
//					}
//				}
//
//				if (UObject* ObjPath = GCFAudioSettings->UserSettingsControlBusMix.TryLoad())
//				{
...
//					else
//					{
//						ensureMsgf(SoundControlBusMix, TEXT("User Settings Control Bus Mix reference missing from GCF Audio Settings."));
//					}
//				}
//			}
//		}
...
//}
//
//void UGCFSettingsLocal::OnAppActivationStateChanged(bool bIsActive)
//{
//	// We might want to adjust the frame rate when the app loses/gains focus on multi-window platforms
//	UpdateEffectiveFrameRateLimit();
//}
//
//void UGCFSettingsLocal::UpdateGameModeDeviceProfileAndFps()
//{
//#if WITH_EDITOR
...
//
//	const UGCFPlatformSpecificRenderingSettings* PlatformSettings = UGCFPlatformSpecificRenderingSettings::Get();
//	const TArray<FGCFQualityDeviceProfileVariant>& UserFacingVariants = PlatformSettings->UserFacingDeviceProfileOptions;
//
...
//
//	int32 SuffixIndex = UserFacingVariants.IndexOfByPredicate([&](const FGCFQualityDeviceProfileVariant& Data){ return Data.DeviceProfileSuffix == UserChosenDeviceProfileSuffix; });
...
//	if (GIsEditor)
//	{
//		const UGCFPlatformEmulationSettings* Settings = GetDefault<UGCFPlatformEmulationSettings>();
...
//	{
//	case EGCFFramePacingMode::MobileStyle:
//		UpdateMobileFramePacing();
//		break;
//	case EGCFFramePacingMode::ConsoleStyle:
//		UpdateConsoleFramePacing();
//		break;
//	case EGCFFramePacingMode::DesktopStyle:
//		UpdateDesktopFramePacing();
//		break;
//	}
//}
//
//void UGCFSettingsLocal::UpdateConsoleFramePacing()
//{
...
//}
//
//void UGCFSettingsLocal::UpdateDesktopFramePacing()
//{
...
//}
//
//void UGCFSettingsLocal::UpdateMobileFramePacing()
//{
...
//}
//
//void UGCFSettingsLocal::UpdateDynamicResFrameTime(float TargetFPS)
//{
