...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GCFVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// FGCFVerbMessage

FString FGCFVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FGCFVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UGCFVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UGCFVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UGCFVerbMessageHelpers::VerbMessageToCueParameters(const FGCFVerbMessage& Message)
{
...
FGCFVerbMessage UGCFVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FGCFVerbMessage Result;
