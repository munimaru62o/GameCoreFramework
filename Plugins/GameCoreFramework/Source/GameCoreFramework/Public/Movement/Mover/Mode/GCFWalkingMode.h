...
#include "GCFWalkingMode.generated.h"
...
/**
 * @brief Custom flying mode extending the base Mover UWalkingMode.
 *
...
class GAMECOREFRAMEWORK_API UGCFWalkingMode : public UWalkingMode
{
    GENERATED_BODY()
