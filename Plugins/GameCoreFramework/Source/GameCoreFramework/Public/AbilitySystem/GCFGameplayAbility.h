 ...
 */
UCLASS(MinimalAPI, Abstract, HideCategories = Input, Meta = (ShortTooltip = "The base gameplay ability class."))
class UGCFGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	UE_API UGCFGameplayAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "GCF|Ability")
	UE_API UGCFAbilitySystemComponent* GetGCFAbilitySystemComponentFromActorInfo() const;
	...
	UFUNCTION(BlueprintCallable, Category = "GCF|Ability")
	UE_API AActor* GetAvatarFromActorInfo() const;
	template <typename T>
...
//	UE_API bool CanChangeActivationGroup(EGCFAbilityActivationGroup NewGroup) const;
//
//	// Tries to change the activation group.  Returns true if it successfully changed.
//	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "GCF|Ability", Meta = (ExpandBoolAsExecs = "ReturnValue"))
//	UE_API bool ChangeActivationGroup(EGCFAbilityActivationGroup NewGroup);
//
//	// Sets the ability's camera mode.
//	UFUNCTION(BlueprintCallable, Category = "GCF|Ability")
//	UE_API void SetCameraMode(TSubclassOf<UGCFCameraMode> CameraMode);
//
...
//
	...
	UE_API virtual void GetAbilitySource(FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, float& OutSourceLevel, const IGCFAbilitySourceInterface*& OutAbilitySource, AActor*& OutEffectCauser) const;
