...
#include "GCFAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FGCFAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UGCFAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FGCFAbilityTagRelationship> AbilityTagRelationships;
