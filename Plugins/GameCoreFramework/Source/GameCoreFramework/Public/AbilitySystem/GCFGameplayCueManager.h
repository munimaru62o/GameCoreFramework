...
#include "GCFGameplayCueManager.generated.h"
...
/**
 * UGCFGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UGCFGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UGCFGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UGCFGameplayCueManager* Get();
