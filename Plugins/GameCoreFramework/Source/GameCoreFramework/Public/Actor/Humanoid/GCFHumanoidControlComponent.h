...
#include "GCFHumanoidControlComponent.generated.h"
...
/**
 * @brief Component that handles Humanoid-specific discrete action inputs (e.g., Crouch).
 *
 * [Responsibilities]
 ...
 * 3. Forwards boolean commands directly to the owning AGCFHumanoid.
...
class UGCFHumanoidControlComponent : public UPawnComponent
{
	GENERATED_BODY()

public:
	UE_API UGCFHumanoidControlComponent(const FObjectInitializer& ObjectInitializer);
