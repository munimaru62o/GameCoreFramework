...
class AGCFAvatarPawnWithAbilities : public AGCFAvatarPawn, public IAbilitySystemInterface, public IGameplayCueInterface
{
	GENERATED_BODY()

public:
	UE_API AGCFAvatarPawnWithAbilities(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
