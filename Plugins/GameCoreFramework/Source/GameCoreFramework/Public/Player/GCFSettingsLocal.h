...
#include "GCFSettingsLocal.generated.h"

enum class ECommonInputType : uint8;
enum class EGCFDisplayablePerformanceStat : uint8;
enum class EGCFStatDisplayMode : uint8;
...
USTRUCT()
struct FGCFScalabilitySnapshot
{
	GENERATED_BODY()

	FGCFScalabilitySnapshot() {};
 ...
 */
UCLASS()
class UGCFSettingsLocal : public UGameUserSettings
{
	GENERATED_BODY()
...
//	EGCFStatDisplayMode GetPerfStatDisplayState(EGCFDisplayablePerformanceStat Stat) const;
//	
//	/** Sets the display mode for the specified performance stat */
//	void SetPerfStatDisplayState(EGCFDisplayablePerformanceStat Stat, EGCFStatDisplayMode DisplayMode);
//
//	/** Fired when the display state for a performance stat has changed, or the settings are applied */
//	DECLARE_EVENT(UGCFSettingsLocal, FPerfStatSettingsChanged);
...
//	
//	DECLARE_EVENT(UGCFSettingsLocal, FLatencyFlashInidicatorSettingChanged);
//	UFUNCTION()
...
//	
//	DECLARE_EVENT(UGCFSettingsLocal, FLatencyStatEnabledSettingChanged);
...
//	//UPROPERTY(Config)
//	//TMap<EGCFDisplayablePerformanceStat, EGCFStatDisplayMode> DisplayStatList;
//
...
//	void OverrideQualityLevelsToScalabilityMode(const FGCFScalabilitySnapshot& InMode, Scalability::FQualityLevels& InOutLevels);
//
...
//
//	FGCFScalabilitySnapshot DeviceDefaultScalabilitySettings;
//
...
//	// Audio - Volume
//public:
//	DECLARE_EVENT_OneParam(UGCFSettingsLocal, FAudioDeviceChanged, const FString& /*DeviceId*/);
