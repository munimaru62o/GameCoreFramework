...
#include "GCFAssetManagerStartupJob.h"
...
protected:
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UGCFGameData> GCFGameDataPath;
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UGCFPawnData> DefaultPawnData;
...
template<typename AssetType>
AssetType* UGCFAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template<typename AssetType>
TSubclassOf<AssetType> UGCFAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
