...
class UGCFExperienceManagerComponent;
class UObject;
struct FFrame;
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "GCF|GameState")
...
private:
	...
	UPROPERTY()
	TObjectPtr<UGCFExperienceManagerComponent> ExperienceManagerComponent;

	// The ability system component subobject for game-wide things (primarily gameplay cues)
	UPROPERTY(VisibleAnywhere, Category = "GCF|GameState")
