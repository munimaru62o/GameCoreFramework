...
#include "GCFAsyncAction_ExperienceReady.generated.h"
 ...
 */
UCLASS()
class UGCFAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
...
public:
	...
	static UGCFAsyncAction_ExperienceReady* WaitForExperienceReady(UObject* WorldContextObject);
...
private:
	...
	void Step3_HandleExperienceLoaded(const UGCFExperienceDefinition* CurrentExperience);
