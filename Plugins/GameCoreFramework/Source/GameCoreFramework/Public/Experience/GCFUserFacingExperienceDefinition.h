...
#include "GCFUserFacingExperienceDefinition.generated.h"
...
class UGCFUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="GCFExperienceDefinition"))
